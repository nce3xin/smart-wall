...
if __name__=='__main__':
    ...
    for i in range(5):
        ...
        if model_name=='ResNet':
            ...
            checkpointer = ModelCheckpoint(filepath='./ckps/resnet18/weights-{epoch:03d}-{val_acc:.3f}.hdf5', monitor='val_acc', verbose=1, save_best_only=True, mode='max', period=1)
